...
public final class kemtrinam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Kem trị nám</title>\n");
    ...
    ResultSet rs=st.executeQuery("select maSP,maLoai,tenSP,nhaSanXuat,PARSENAME(convert(varchar,convert(money,donGia),1),2 ) as donGia,hinhAnh from SP where maloai='l4'");
