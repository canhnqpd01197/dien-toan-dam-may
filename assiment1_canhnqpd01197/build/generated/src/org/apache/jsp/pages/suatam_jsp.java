...
public final class suatam_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    ResultSet rs=st.executeQuery("select maSP,maLoai,tenSP,nhaSanXuat,PARSENAME(convert(varchar,convert(money,donGia),1),2 ) as donGia,hinhAnh from SP where maloai='l1'");
