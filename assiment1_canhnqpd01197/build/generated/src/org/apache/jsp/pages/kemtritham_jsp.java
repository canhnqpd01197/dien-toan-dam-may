...
public final class kemtritham_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(HttpServletRequest request, HttpServletResponse response)
    ...
    try {
      ...
      out.write("<title>Kem trị thâm</title>\n");
    ...
    ResultSet rs=st.executeQuery("select maSP,maLoai,tenSP,nhaSanXuat,PARSENAME(convert(varchar,convert(money,donGia),1),2 ) as donGia,hinhAnh from SP where maloai='l5'");
