...
<div id="sliderFrame">
    ...
    <ul class="menuCon">
        <li><a href="pages/kemtrimun.jsp">Kem trị mụn</a></li>
    <li><a href="pages/kemtrangda.jsp">Kem trắng da</a></li>
    <li><a href="pages/kemtrinam.jsp">Kem trị nám</a></li>
    <li><a href="pages/kemtritham.jsp">Kem trị thâm</a></li>
    <li><a href="pages/suatam.jsp">Sữa tắm</a></li>
    </ul>
    </li>
    <li><a href="index.jsp">Trang chủ</a></li>
    <li><a href="pages/gioithieu.jsp">Giới thiệu</a></li>
    <li><a href="pages/sanpham.jsp">Sản phẩm</a></li>
    <li><a href="pages/lienhe.jsp">Liên hệ</a></li>
    <li <%=servlet.dangnhap.display%> class="DN"><a href="pages/dangnhap.jsp" class="DK">Đăng nhập</a><span class="gachngang"> - </span><a class="DK" href="pages/dangki.jsp">Đăng kí</a></li>
    <li class="lidn" style="color: chartreuse;<%=servlet.dangnhap.displayDN%>"><%=servlet.dangnhap.userN%>
        <ul style="position: absolute;">
            ...
            <li style="float: none"><a style="color: chartreuse;" href="pages/doimatkhau.jsp">Đổi mật khẩu</a></li>
